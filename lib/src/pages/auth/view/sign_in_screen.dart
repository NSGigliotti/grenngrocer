...
import 'package:grenngrocer/src/pages/auth/view/components/forgot_password_dialog.dart';
                    ...
                    children: [
                          ...
                          onPressed: () async {
                            ...
                            if (result ?? false) {
                              utilsServices.showToast(
                                  message:
                                      'Um link de recuperaçao foi enviado para seu email');
                            }
                          },
                          child: Text(
                            'Esqueceu a senha?',
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          onPressed: () {
                            Get.toNamed(PageRoutes.songUpRoutes);
                          },
                          child: const Text(
                            'Criar conta',
                            style: TextStyle(
