...
mixin _$CartResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String mensagen) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(String mensagen)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
/// @nodoc
class __$$SuccessCopyWithImpl<T, $Res> extends _$CartResultCopyWithImpl<T, $Res>
...
abstract class _$$ErrorCopyWith<T, $Res> {
  ...
  $Res call({String mensagen});
}

/// @nodoc
class __$$ErrorCopyWithImpl<T, $Res> extends _$CartResultCopyWithImpl<T, $Res>
  ...
  @override
  $Res call({
    Object? mensagen = freezed,
  }) {
    return _then(_$Error<T>(
      mensagen == freezed
          ? _value.mensagen
          : mensagen // ignore: cast_nullable_to_non_nullable
              as String,
    ));
  }
}
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CartResult<$T>.error(mensagen: $mensagen)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$Error<T> &&
            const DeepCollectionEquality().equals(other.mensagen, mensagen));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(mensagen));
...
abstract class Error<T> implements CartResult<T> {
  factory Error(final String mensagen) = _$Error<T>;
