...
import 'package:grenngrocer/src/pages/cart/repository/cart_repository.dart';
...
class CartController extends GetxController {
  ...
  void setChecoltLoading(bool value) {
    isCheckoutLoading = value;
    update();
  }

  Future checkoutCart() async {
    setChecoltLoading(true);
  ...
  Future<bool> changeItemQuantity(
    ...
    if (result) {
      ...
      utilsServices.showToast(
          message: 'Occoreu um erro ao alterar a quantidade', isError: true);
    }
